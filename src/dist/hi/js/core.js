...
(function() {
  ...
  document.querySelectorAll('.checklist-item input[type="checkbox"]').forEach(function(cb) {
    var label = cb.nextElementSibling;
    var key = cb.dataset.key || (label ? label.textContent.trim() : 'item');
    key = 'sodcalc_' + key;
    // Restore state
...
// Back to top button
  ...
  btt.setAttribute('aria-label', (function(l){var a={'zh-CN':'返回顶部',es:'Volver arriba',hi:'ऊपर जाएं',ar:'العودة للأعلى',pt:'Voltar ao topo',fr:'Retour en haut',ja:'トップに戻る'};return a[l]||'Back to top';})(document.documentElement.lang||'en'));
  btt.textContent = '\u2191';
